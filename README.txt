...
a persistence unit "jakstik-systemPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "jakstik-system/pom.xml":
...
artifacts ("jakstik-system-ejb.jar" and "jakstik-system-web.war") are already built. You can build
